/*
 ...
 Source Server         : 103.42.215.166
 Source Server Type    : PostgreSQL
 Source Server Version : 90323
 Source Host           : 103.42.215.166:5432
 Source Catalog        : freda_db
...
CREATE TABLE "public"."archive" (
  ...
  "preview" varchar(200) COLLATE "pg_catalog"."default",
  "tag" varchar(50) COLLATE "pg_catalog"."default",
  "type" varchar(50) COLLATE "pg_catalog"."default",
  "source_link" varchar(300) COLLATE "pg_catalog"."default",
  "state" int4,
  "create_time" timestamptz(6),
  "update_time" timestamptz(6)
)
;
COMMENT ON TABLE "public"."archive" IS '文档表';

-- ----------------------------
-- Records of archive
-- ----------------------------
INSERT INTO "public"."archive" VALUES ('6', '项目管理基本概念', 'Jason', '##什么是项目
...
INSERT INTO "public"."archive" VALUES ('3', 'Linux防火墙开放端口号', 'Jason', 'Linux防火墙开放端口号
...
INSERT INTO "public"."archive" VALUES ('cbd93a2b253c40cab7b2265fb0359395', 'Running Your Spring Boot Application', 'spring.io', '## 19. Running Your Application
...
INSERT INTO "public"."archive" VALUES ('015bf1bcec8040f0b4b4a3355f65b4ba', '修改ubuntu1604源', 'Jason Yang', '修改ubuntu1604源
```
...
INSERT INTO "public"."archive" VALUES ('e669d01c5a0b45d1a7c8a510a4415a34', '反向代理', 'github', '#### 什么是反向代理
...
INSERT INTO "public"."archive" VALUES ('9e627d82a0eb462291194292e3a8b0b8', 'Google Java编程风格指南', 'Hawstein', '
...
INSERT INTO "public"."archive" VALUES ('262c67e2a47e4a638db747471752ce0a', 'ARTS03-20180722', 'Jason Yang', '## What is ARTS ?
...
INSERT INTO "public"."archive" VALUES ('2', 'JavaScript基础', 'Jason', '
##维基百科的描述
...
INSERT INTO "public"."archive" VALUES ('5', 'linux下安装jdk', 'Jason', '下载jdk.tar.gz，创建java目录
```
...
INSERT INTO "public"."archive" VALUES ('7', '燃起的烟火照亮谁的脸', 'Jason', '>近期的四个项目都发布了，终于可以松一口气，暂时过一个轻松的周末，却兴奋的睡不着觉，不如写点啥吧。
...
INSERT INTO "public"."archive" VALUES ('8', '试试敏捷开发？', 'Jason', '**曾经的我们**
...
INSERT INTO "public"."archive" VALUES ('0551d957af224b809fcb2990505beedf', 'ARTS02-20180715', 'Jason Yang', '## What is ARTS ?
...
INSERT INTO "public"."archive" VALUES ('9', '正则表达式', 'Jason', '正则表达式在线测试工具 http://tool.chinaz.com/regex/
...
INSERT INTO "public"."archive" VALUES ('11', 'Java8 lambda表达式10个示例', 'ImportNew - lemeille', '>本文由 ImportNew - lemeilleur 翻译自 javarevisited。欢迎加入翻译小组。转载请见文末要求。
...
INSERT INTO "public"."archive" VALUES ('9e43357b9f5f452ba685adf7617dfb70', 'ubuntu 安装ElasticSearch过程中的问题记录', 'Jason Yang', '**开放端口**
...
INSERT INTO "public"."archive" VALUES ('b33da4bfe433491f92d6c1e12f46d531', '20条数据库设计最佳实践', 'Jason Yang', '> 翻译自 https://dzone.com/articles/20-database-design-best
...
INSERT INTO "public"."archive" VALUES ('bd8574229a21477896f07231b619737b', 'Docker Practice Notes 01', 'Jason Yang', '## Docker的三个基本概念
- 镜像（Image）
- 容器（Container）
- 仓库（Repository）
...
INSERT INTO "public"."archive" VALUES ('9a037da9ee4147cc91b37e2a247d108e', 'ARTS01-20180707', 'Jason Yang', '## What is ARTS ?
...
INSERT INTO "public"."archive" VALUES ('12', 'Python 两个经典递归：阶乘和幂', 'Jason', '**递归**简单说来就是调用自身的意思。
...
INSERT INTO "public"."archive" VALUES ('14', 'Spring 数据库密码加密', 'Jason Yang', '>我们一般都会把数据库的连接信息写在properties配置文件里，只要打开了配置文件，就能直接看到数据库的用户名密码等信息，一些项目会要求不能出现明文密码，接下来，简单三步，实现配置文件里的用户名和密码加密。
...
INSERT INTO "public"."archive" VALUES ('15', 'IntelliJ IDEA For Mac 快捷键', 'Givefine', '> 原文地址：http://www.cnblogs.com/wxd0108/p/5295017.html
...
INSERT INTO "public"."archive" VALUES ('18', 'Mac 键盘快捷键', 'Apple', '您可以按组合键来实现通常需要鼠标、触控板或其他输入设备才能完成的操作。
...
INSERT INTO "public"."archive" VALUES ('1a7b20508fae44d884b07e5bc3e2064f', 'StrongLoop compare with pm2 and Forever', 'http://strong-pm.io', '
...
INSERT INTO "public"."archive" VALUES ('7a8a68a10ff945b2b48d1d853b655480', 'JMockit unit test', 'Jason Yang', '
- JMockit官网
...
INSERT INTO "public"."archive" VALUES ('b681a4d83ff54cefad6cd82c2dafe6d9', 'Mac 下 MySQL 开启 bin log', 'Jason Yang', 'MySQL for Mac 默认 bin log 是关闭的，使用以下命令查看 bin log 是否开启：
```sql
...
INSERT INTO "public"."archive" VALUES ('20', '策略模式', 'runoob.com', '
...
INSERT INTO "public"."archive" VALUES ('21', '装饰器模式', 'runoob.com', '
...
INSERT INTO "public"."archive" VALUES ('22', '什么时候动手', 'Jason Yang', '> 接到一个编程任务后，你首先想到要做的事情是什么呢？', '<blockquote>
<p>接到一个编程任务后，你首先想到要做的事情是什么呢？</p>
</blockquote>
', '总是急于求成，却发现自己并没有做好充分准备', '杂谈', NULL, NULL, 1, '2017-06-29 03:37:26.262+01', '2017-10-04 03:18:38.727+01');
INSERT INTO "public"."archive" VALUES ('23', 'Mac 下安装 Apache Ant™', 'Jason Yang', '> Apache Ant™ is a Java library and command-line tool that help building software.
...
INSERT INTO "public"."archive" VALUES ('24', '单例模式', 'runoob.com', '# 单例模式
...
INSERT INTO "public"."archive" VALUES ('25', 'Freda项目更新计划', 'Jason Yang', '> 好久没有更新博客了，心里满满的罪恶感。这篇给Freda项目将来的一段时间简单的列一些更新计划。
...
INSERT INTO "public"."archive" VALUES ('543c0476886f4f0c9b17cd6038709568', 'ssh -qTfnN -D 7070 xxx@xxx.com ', 'Jason Yang', 'ssh -qTfnN -D 7070 xxx@xxx.com 
...
INSERT INTO "public"."archive" VALUES ('33', 'Integrate an H2 Database in Your Spring Boot App', 'Jose Praveen T', '> 原文地址 https://dzone.com/articles/integrate-h2-database-in-your-spring-boot-applicat
...
INSERT INTO "public"."archive" VALUES ('00abf6872c3b4c53bfb59ea40b0106de', 'ARTS04-20180728', 'Jason Yang', '## Algorithm
...
INSERT INTO "public"."archive" VALUES ('4a0988f6374f4cfdb2f4570bc1ac8922', 'ARTS05-20180804', 'Jason Yang', '# ARTS05-20180804
...
INSERT INTO "public"."archive" VALUES ('578bac7947be450cb91039d591ba4e62', 'ARTS06-20180811', 'Jason Yang', '# ARTS06-20180811
...
INSERT INTO "public"."archive" VALUES ('26', 'mac osx ruby 升级', 'Jason Yang', '>又偏离航线了，一开始就为了装个黑域，从安装adb到更新homebrew、再到更新ruby，我在瞎折腾的路上无法自拔。。。
...
INSERT INTO "public"."archive" VALUES ('27', '不能改变，那就接受', 'Jason Yang', '> 这篇文章是写给爱抱怨的人的。同时，也是写给自己的。
...
INSERT INTO "public"."archive" VALUES ('335239a2e62a471e939fbb6dbbb6e7bf', 'ARTS07-20180818', 'Jason Yang', '# ARTS07-20180818
...
INSERT INTO "public"."archive" VALUES ('a8306e5f4a294020aca5f6a8eeda18d5', 'ARTS08-20180826', 'Jason Yang', '## Algorithm
...
INSERT INTO "public"."archive" VALUES ('1', 'Python 另一个经典递归：二分法查找', 'Jason', '先来玩个数字游戏，我从1～100中选一个整数，你来猜中这个数字。
...
INSERT INTO "public"."archive" VALUES ('29', 'The Lazy Song', 'Jason Yang', 'Song Title: The Lazy Song
Artist: Bruno Mars
...
INSERT INTO "public"."archive" VALUES ('30', 'Typecho数据库设计', 'Typecho', '##主体结构
###单用户博客数据量如何
...
INSERT INTO "public"."archive" VALUES ('32', '可以评论了', 'Jason Yang', '增加了评论表，实现了评论基本功能，评论回复、审核、删除功能待完善', '<p>增加了评论表，实现了评论基本功能，评论回复、审核、删除功能待完善...</p>
', '增加了评论表，实现了评论基本功能，评论回复、审核、删除功能待完善', '博客', NULL, NULL, 1, '2018-02-04 12:11:33.33+00', '2018-04-12 20:49:45.931+01');
INSERT INTO "public"."archive" VALUES ('10', '求真务实', 'Jason', '>求真，深入了解用户的业务以及日常工作，掌握每个业务的细节，真实的使用场景。
...
INSERT INTO "public"."archive" VALUES ('13', 'Apache Commons Codec 加密解密', 'Jason Yang', 'Apache Commons Codec 提供了常见的编码器和解码器，如Base64，Hex等。
...
INSERT INTO "public"."archive" VALUES ('19', '使用枚举替换常量类', 'Jason Yang', '>项目中必然会用到常量，我接触过的一些老旧项目，基本都是用常量类或接口类来定义常量。Java1.5以后，JDK中引入了枚举类，清晰又简单。
...
INSERT INTO "public"."archive" VALUES ('28', 'windows下把exe程序注册成服务', 'Jason Yang', 'windows下把exe程序注册成服务
...
INSERT INTO "public"."archive" VALUES ('31', 'mac卸载postgresql', 'Jason Yang', '这里针对的是 9.6 版本。如是其他版下面的仅供参考。
...
INSERT INTO "public"."archive" VALUES ('36', '情绪控制', 'Jason Yang', '**引言**
...
INSERT INTO "public"."archive" VALUES ('37', 'Jenkins持续集成', 'Jason Yang', '
**使用jenkins进行持续集成**
...
INSERT INTO "public"."archive" VALUES ('39', '夜未眠-程序员的心声', 'Jason Yang', '## 引言
...
INSERT INTO "public"."archive" VALUES ('40', '几道Java面试题', 'Jason Yang', '## 引言
...
INSERT INTO "public"."archive" VALUES ('41', '装饰器模式之真假美猴王', 'Jason Yang', '![](https://raw.githubusercontent.com/jasonyang86/nocoder/master/data/images/design-pattern/sunwukong_sixears.jpeg)
...
INSERT INTO "public"."archive" VALUES ('34', 'Java 二分查找法', 'Jason Yang', '> 二分查找法是一种常见的对数值列表的查找方法。使用二分查找法的前提条件是数组中的元素必须已经排好序。二分查找法首先将关键字与数组的中间元素进行比较。考虑一下三种情况：
...
INSERT INTO "public"."archive" VALUES ('35', '多线程复习笔记', 'Jason Yang', '## 引言
...
INSERT INTO "public"."archive" VALUES ('38', 'JAVA HttpURLConnection Post方式提交传递参数', 'w348399060', '> 原文链接：https://blog.csdn.net/w348399060/article/details/62424502
...
CREATE TABLE "public"."comment" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "archive_id" varchar(32) COLLATE "pg_catalog"."default",
  "comment_username" text COLLATE "pg_catalog"."default",
  "comment_user_email" varchar(100) COLLATE "pg_catalog"."default",
  "comment_user_ip_address" varchar(50) COLLATE "pg_catalog"."default",
  "comment_content" text COLLATE "pg_catalog"."default",
  "create_time" timestamp(6),
  "pid" varchar(32) COLLATE "pg_catalog"."default"
)
;
COMMENT ON COLUMN "public"."comment"."pid" IS '父ID';

-- ----------------------------
-- Records of comment
-- ----------------------------
INSERT INTO "public"."comment" VALUES ('fdcecd73e2984ff08657fd2b551dfc81', '32', 'Jason', NULL, NULL, '对昵称和评论内容进行了非空和长度校验，昵称50不能超过50字，评论内容不能超过3000字。', '2018-02-04 20:39:38.038', NULL);
INSERT INTO "public"."comment" VALUES ('d63df44868e2433c9f89444afbb5cb88', '32', 'Jason', NULL, NULL, '增加了评论表，实现了评论基本功能，评论回复、审核、删除功能待完善', '2018-02-05 12:39:49.846', NULL);
INSERT INTO "public"."comment" VALUES ('8ac56f1158b04a6599a037449e1a7ecc', '32', 'billy', NULL, NULL, '什么乱七八糟的东西，哎', '2018-02-05 12:41:00.67', NULL);
INSERT INTO "public"."comment" VALUES ('667bf1e57006466184f56a0cf6ca0851', '32', 'billy', NULL, NULL, '哥们，关注我', '2018-02-05 12:41:26.196', NULL);
INSERT INTO "public"."comment" VALUES ('42f3e4f09f014f4b9c6ce8c2fee53baa', '32', '№№№№', NULL, NULL, '№№№№№№№№№№№№№№№№№№№№№№', '2018-02-05 12:42:25.394', NULL);
INSERT INTO "public"."comment" VALUES ('a9c1ad01e0d04586b89d055d770c1162', '32', '▲※↑◇◆◎※◇◆☆※↑', NULL, NULL, '▲※↑◇◆◎※◇◆☆※↑', '2018-02-05 12:42:32.852', NULL);
INSERT INTO "public"."comment" VALUES ('0d0651c0d68744d4a6a29a9bc484fe72', '32', 'billy', NULL, NULL, '咋回事嘛，居然还有乱码，处理一下嘛', '2018-02-05 12:43:16.162', NULL);
INSERT INTO "public"."comment" VALUES ('3b7645438ce543dcaec4d4c94c36724c', '32', 'Jason', NULL, NULL, '楼下唐长老', '2018-02-05 23:14:47.95', NULL);
INSERT INTO "public"."comment" VALUES ('34bfa24b53574150a7acf39daa77f28e', '32', '据说昵称不能超过50个字在下不服来试一试真的吗50个字能行吗', NULL, NULL, 'JavaScript 中，万物皆对象！但对象也是有区别的。分为普通对象和函数对象，Object 、Function 是 JS 自带的函数对象。下面举例说明
...
INSERT INTO "public"."comment" VALUES ('3bc54b5f58364861b7f9bd9c3372c40e', '32', 'billyzhang', NULL, NULL, '图片加载有点慢啊', '2018-02-06 23:04:28.718', NULL);
INSERT INTO "public"."comment" VALUES ('41714f16602e4ac8aff97cba7b7d958f', '32', 'httr', NULL, NULL, 'ssss', '2018-02-27 15:18:07.151', NULL);
INSERT INTO "public"."comment" VALUES ('b0a218ce874e4fb5a1962f0545b0b4da', '32', '据说昵称不能超过50个', NULL, NULL, 'JavaScript 中，万物皆对象！但对象也是有区别的。分为普通对象和函数对象，Object 、Function 是 JS 自带的函数对象。', '2018-02-27 15:18:56.942', NULL);
INSERT INTO "public"."comment" VALUES ('8b2b5baa3f744f45a18323c0ec6bb17d', '27', 'Jason', NULL, NULL, '又在抱怨，有什么用，冷静下来，理智面对吧', '2018-03-07 09:19:37.609', NULL);
INSERT INTO "public"."comment" VALUES ('f78096b6668a47039114c1eae6e793ac', '28', '决定离开房间可是老大', NULL, NULL, 'alert("hello")', '2018-02-11 17:57:50.692', NULL);
INSERT INTO "public"."comment" VALUES ('c52976ef153e457d8d363b20c70062b4', '32', 'alert("hello")', NULL, NULL, 'alert("hello")', '2018-03-01 11:11:34.725', NULL);
INSERT INTO "public"."comment" VALUES ('2f2d03ae65f1471d8cabc87bb1235472', '32', '你好', NULL, NULL, 'setInterval(function(){
alert("hello");
},1000)</script>', '2018-03-01 11:12:58.834', NULL);
INSERT INTO "public"."comment" VALUES ('f50cb6a0f1e945cc9db0da64bea6591d', '32', 'aa', NULL, NULL, 'aa', '2018-04-02 11:42:24.666', NULL);
INSERT INTO "public"."comment" VALUES ('1cf100dff129409fa76ae2708ec5efd5', '32', '&lt;script&gt;alert(0)&lt;/script&gt;', NULL, NULL, '&lt;script&gt;alert(0)&lt;/script&gt;', '2018-04-02 13:26:28.658', NULL);
INSERT INTO "public"."comment" VALUES ('ee6f0aa501a04e1dbdee44b606351d9a', '32', '&lt;script&gt;alert(0)&lt;/script&gt;', NULL, NULL, '&lt;script&gt;alert(0)&lt;/script&gt;', '2018-04-02 13:26:36.811', NULL);
INSERT INTO "public"."comment" VALUES ('5094826abfa04136ab0097af7077961f', '31', '&lt;script&gt;alert("script bug")&lt;/script&gt;', NULL, NULL, '&lt;script&gt;alert("script bug")&lt;/script&gt;', '2018-04-05 00:38:06.297', NULL);
INSERT INTO "public"."comment" VALUES ('c30282b24f154d1c9615361f1c25f1ed', '32', 'test', NULL, NULL, 'test', '2018-04-02 14:35:30.144', NULL);
INSERT INTO "public"."comment" VALUES ('da9adde7396b427481a88e6d3296586c', '32', '测试脚本注入', NULL, NULL, '&lt;script&gt;
$(".card-body").text("测试，修改侧边标签页")
&lt;/script&gt;', '2018-04-05 00:39:52.608', NULL);
INSERT INTO "public"."comment" VALUES ('d9f158bab5c24c4b817f0837abf4cf94', '32', 'nicheng ', NULL, NULL, 'function(){var div=document.createElement("div");div.appendChild(document.createTextNode("text"));div.innerHTML()}()', '2018-04-02 14:30:59.901', NULL);
INSERT INTO "public"."comment" VALUES ('5843110c42494b98870e502ef1fab465', '32', 'test', NULL, NULL, 'function(){var div=document.createElement("div");div.appendChild(document.createTextNode("textxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"));div.innerHTML}()', '2018-04-02 14:32:05.913', NULL);
INSERT INTO "public"."comment" VALUES ('c7db10b595f8431dbb47041f14336e4c', NULL, NULL, NULL, NULL, NULL, '2018-04-25 01:12:37.606', NULL);
...
-- Records of persons
-- ----------------------------
INSERT INTO "public"."persons" VALUES (1, 'Jason', 'Yang');
...
-- Records of user
-- ----------------------------
INSERT INTO "public"."user" VALUES ('1', 'jason', 'freda1437', NULL, NULL, NULL);
...
SELECT setval('"public"."persons_id_seq"', 2, true);
